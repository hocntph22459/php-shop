...
<head>
    ...
    <link href="../../views/src/css/admin/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
            ...
            <div class="col-lg-6 mb-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="small font-weight-bold">Theo dõi bán hàng <span
    ...
    <script src="../../views/src/vendor/jquery/jquery.min.js"></script>
    <script src="../../views/src/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- Core plugin JavaScript-->
    <script src="../../views/src/vendor/jquery-easing/jquery.easing.min.js"></script>
    <!-- Custom scripts for all pages-->
    <script src="../../views/src/js/sb-admin-2.min.js"></script>
    <!-- Page level plugins -->
    <script src="../../views/src/vendor/chart.js/Chart.min.js"></script>
    <!-- Page level custom scripts -->
    <script src="../../views/src/js/demo/chart-area-demo.js"></script>
    <script src="../../views/src/js/demo/chart-pie-demo.js"></script>
