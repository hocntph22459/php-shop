    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="tile">
                    <h3>Sửa loại hàng</h3>
                    <a class="" href="http://localhost/da1/controller/admin/?url=loai-hang">quay lại danh sách</a>
                </div>
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control my-4" placeholder="Nhập tên" name="tenloai" value="<?php if(isset($cateone)){echo $cateone['name'];} ?>">
                    </div>
