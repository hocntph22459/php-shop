    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="tile">
                    <h3>Sửa màu</h3>
                    <a class="" href="http://localhost/da1/admin/?url=attributes">quay lại danh sách</a>
                </div>
                <form action="" method="post">
                    <div class="mb-3 mt-3">
                        <label for="" class="form-label">Mã thuộc tính</label>
                        <input type="text" class="form-control my-4" placeholder="auto number" name="id" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Tên sản phẩm</label>
                        <select name="idsp" id="" class="form-control my-4">   
                        <?php foreach ($listsanpham as $sanpham) : ?>
                            <?php
                                if($sanpham['id'] == $attributes['id_product']){
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control my-4" placeholder="Nhập kích cỡ" name="kichco" value="<?=$attributes['size']?>">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Màu sản phẩm</label>
                        <input type="text" class="form-control my-4" placeholder="Nhập màu" name="mau" value="<?=$attributes['color']?>">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Số lượng</label>
                        <input type="text" class="form-control my-4" placeholder="Nhập số lượng" name="soluong" value="<?=$attributes['quantity']?>">
                    </div>
