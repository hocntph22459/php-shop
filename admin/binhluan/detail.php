        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <table class="table table-hover table-dark">
                    ...
                    <tbody>
                        <?php foreach ($binhluanct as $value) : ?>
                            <tr>
                                <th scope="row"><?= $value['contents'] ?></th>
                                <th scope="row"><?= $value['date_comment'] ?></th>
                                <th scope="row"><?= $value['user_name'] ?></th>
                                <td>      
                                    <a onclick="return confirm('bạn có chắc xóa?')" href="http://localhost/da1/admin/?url=delete-binh-luan&id_bl=<?=$value['id']?>"><img src="../views/src/image/admin/delete.svg" alt=""></a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
