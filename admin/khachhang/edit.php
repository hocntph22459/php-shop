...
<div class="tile">
                    ...
                    <a class="" href="http://localhost/da1/admin/?url=khach-hang">quay lại danh sách</a>
                </div>
                <form action="http://localhost/da1/admin/?url=update-khach-hang&id=<?= $khachhang['id'] ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3 mt-3">
