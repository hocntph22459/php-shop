        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="tile">
                    ...
                    <a class="" href="http://localhost/da1/admin/?url=san-pham">quay lại danh sách</a>
                </div>
                <form action="http://localhost/da1/admin/?url=add-san-pham" method="post" enctype="multipart/form-data">
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control my-4" placeholder="Giảm giá sản phẩm" name="giamgia">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="motasp" class="form-control my-4" cols="20" rows="7" placeholder="Nhập mô tả" id="description"></textarea>
                    </div>
