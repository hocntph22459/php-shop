  ...
  <footer class="footer_section">
    <div class="container">
        ...
        <div class="col-md-6 col-lg-3 footer-col">
          <div class="footer_detail">
            ...
            <div class="footer_social">
              <a href="">
                <i class="fa fa-facebook" aria-hidden="true"><img src="./views/src/image/footer/facebook.svg" alt=""></i>
              </a>
              <a href="">
                <i class="fa fa-twitter" aria-hidden="true"><img src="./views/src/image/footer/twitter.svg" alt=""></i>
              </a>
              <a href="">
                <i class="fa fa-instagram" aria-hidden="true"><img src="./views/src/image/footer/email.svg" alt=""></i>
              </a>
            </div>
          </div>
        </div>
      ...
      <div class="footer-info">
        <p>
          &copy; <span id="displayYear"></span> All Rights Reserved By mensbry
        </p>
      </div>
    </div>
  </footer>
