...
<main>
    <div class="slider">
        ...
        <div class="carousel-inner">
            ...
            <img class="d-block w-100" src="./views/src/image/banner/slider1.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
            <img class="d-block w-100" src="./views/src/image/banner/slider1.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
            <img class="d-block w-100" src="./views/src/image/banner/slider1.jpg" alt="Third slide">
            </div>
        </div>
